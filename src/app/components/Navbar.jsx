...
const Navbar = ({}) => {
  ...
  return (
    <>
    {/* add bg image for the status bar*/}
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]'>
        <Image src={assets.header_bg_color} alt="" className='w-full'></Image>
    </div>
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4
      flex items-center justify-between z-50 ${isScroll?"bg-white bg-opacity-50 backdrop-blur-lg shadow-sm" : "bg-transparent"}`}>
        <a href="#top">
        ...
        <div className='flex items-center gap-4'>
            ...
            {/* add tailwindcss classes to the Contact anchor tag */}
